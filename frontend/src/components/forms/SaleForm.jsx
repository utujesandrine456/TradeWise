...
const SaleForm = ({ isOpen, onClose, onSave, setActiveTab }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#09111E]/60 backdrop-blur-sm flex items-center justify-center z-[100] p-6 font-Urbanist cursor-default">
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="bg-gray-50">
                            ...
                            <th className="px-8 py-6 text-center text-xs font-bold text-gray-400 tracking-wide w-44">Unit Price</th>
