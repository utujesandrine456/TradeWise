        ...
        <div className="p-10 border-b border-chocolate-50 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="bg-chocolate-50 p-4 rounded-lg border border-chocolate-100 shadow-sm">
              <MdShoppingCart className="text-chocolate-600 text-3xl" />
            </div>
            <div>
              <h2 className="text-4xl font-#FC9E4F text-chocolate-900 leading-tight">New Purchase Order</h2>
              <p className="text-sm text-chocolate-400 font-medium mt-1">Track Inbound Inventory Acquisitions</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="bg-chocolate-50 border border-chocolate-100 p-16 rounded-lg text-center shadow-sm">
              <div className="max-w-md mx-auto space-y-8">
                <div className="bg-white w-24 h-24 rounded-full flex items-center justify-center mx-auto border border-chocolate-100 shadow-sm">
                  <MdShoppingCart className="text-chocolate-300 text-5xl" />
                </div>
                <div className="space-y-3">
                  <h4 className="text-2xl font-#FC9E4F text-chocolate-900 capitalize">No Products Found</h4>
                  <p className="text-chocolate-500 leading-relaxed font-medium">Your inventory is empty. Please register products before creating purchase orders.</p>
                </div>
                <button
                  type="button"
                  onClick={() => {
            ...
            <>
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-3">
                    <label className="block text-sm font-bold text-chocolate-400 px-1 capitalize">Supplier Name *</label>
                    <input
                      type="text"
                      name="secondParty"
              ...
              <div className="bg-chocolate-50 p-10 rounded-lg border border-chocolate-100 shadow-sm relative overflow-hidden group">
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-chocolate-500 font-medium mt-1">Automatically Generate Debit Or Credit Entries</p>
                    </div>
                  </div>
                  <button
                    type="button"
                ...
                {includeFinancialDetails && (
                  <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="space-y-3">
                      <label className="block text-sm font-bold text-chocolate-400 px-1 capitalize">Payment Type</label>
                      <select
                        name="financialType"
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="bg-chocolate-50">
                            ...
                            <th className="px-8 py-6 text-center text-xs font-#FC9E4F text-chocolate-400 uppercase tracking-widest w-44">Cost Per Unit</th>
