      ...
      <div className="bg-white border border-gray-100 rounded-md shadow-2xl w-full max-w-2xl overflow-hidden relative flex flex-col">
        ...
        <div className="p-10 border-b border-gray-100 flex items-center justify-between relative z-10 bg-gradient-to-r from-gray-50/50 to-transparent">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="text-3xl font-black text-[#09111E] leading-none">Intelligence Feed</h2>
              <p className="text-[10px] font-black text-[#09111E]/60 tracking-normal mt-3 italic opacity-60">Critical System Pulse</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-10 space-y-10 max-h-[70vh] overflow-y-auto custom-scrollbar relative z-10">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1 space-y-6">
              <h3 className="text-3xl font-black text-[#09111E] leading-none">{notification.title}</h3>
              <div className="flex items-center gap-6">
                <span className={`px-6 py-2 text-[10px] font-black rounded-md border  tracking-normal italic ${getImpactColor(notification.impact)}`}>
                  {notification.impact} SEVERITY_LEVEL
                </span>
                {!notification.read && (
                  <span className="px-6 py-2 text-[10px] font-black rounded-md bg-gray-100 text-[#09111E] border border-gray-200 tracking-normal animate-pulse">
                    URGENT_UNREAD
                  </span>
                )}
              </div>
          ...
          {notification.read && (
            <div className="bg-gray-50 border border-gray-100 rounded-md p-8 shadow-inner relative overflow-hidden group">
              <div className="flex items-start gap-8 relative z-10">
                ...
                <div>
                  <h4 className="text-[10px] font-black text-[#09111E] tracking-normal mb-2 italic">Protocol Acknowledged</h4>
                  <p className="text-[10px] text-[#09111E]/60 font-black leading-relaxed opacity-40 italic">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-md p-10 shadow-inner relative overflow-hidden group">
            <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-4 opacity-40 italic">
                ...
                <span className="text-[10px] font-black tracking-normal text-[#09111E]/60">Transmission Payload Content</span>
              </div>
              <p className="text-[#09111E] text-2xl font-black leading-relaxed italic opacity-80">{notification.message}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 border border-gray-100 p-8 rounded-md shadow-inner group hover:bg-gray-100 transition-all">
              <span className="block text-[10px] font-black text-[#09111E]/60 mb-3 px-1 italic opacity-40">Event Category</span>
              <p className="text-[#09111E] font-black leading-tight italic group-hover:text-blue-600 transition-colors">{notification.type}</p>
            </div>

            <div className="bg-gray-50 border border-gray-100 p-8 rounded-md shadow-inner group hover:bg-gray-100 transition-all">
              <span className="block text-[10px] font-black text-[#09111E]/60 mb-3 px-1 italic opacity-40">Delivery Timeline</span>
              <div className="flex items-center gap-3 text-[#09111E] font-black leading-tight italic group-hover:text-blue-600 transition-colors">
                <MdCalendarToday className="text-xl" />
                <span>{formatDate(notification.createdAt)}</span>
              </div>
              <p className="text-[10px] text-[#09111E]/60 mt-2 font-black italic opacity-30 px-1">Relative: {notification.time}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-10 border-t border-gray-100 bg-gray-50/30 flex items-center justify-end gap-10 relative z-10">
          {!notification.read && (
            <button
              ...
              className="group relative px-10 py-5 bg-[#09111E] text-white rounded-md font-black text-[10px] transition-all active:scale-95 shadow-lg overflow-hidden hover:scale-105"
            >
          ...
          <button
            onClick={onClose}
            className="px-10 py-5 bg-white border border-gray-200 text-[#09111E] rounded-md font-black text-[10px] transition-all hover:bg-gray-50 active:scale-95 shadow-sm italic"
          >
