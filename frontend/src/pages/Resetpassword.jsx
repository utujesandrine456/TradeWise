    ...
    <div className='bg-black h-screen flex flex-1 justify-between'>
      ...
      <div className='flex flex-col bg-white pt-10'>
        ...
        <div className='flex flex-col space-y-4 mx-10 my-4'>
          <input type="text" placeholder="Current Password" className='w-100 py-2 px-4 border text-sm border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#BE741E] focus:border-transparent' />
