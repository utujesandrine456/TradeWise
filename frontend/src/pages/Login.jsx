        ...
        <div className="relative z-10 space-y-10">
          <div>
            <h2 className="text-white font-black text-4xl leading-tight mb-4">
              Return to your<br /><span className="text-brand-500">Trading Hub.</span>
            </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-xs font-black text-[#09111E]/60 uppercase tracking-tighter pl-1">Phone or Email</label>
              <input
                type="text"
                name="identifier"
            ...
            <div className="space-y-2">
              <label className="text-xs font-black text-[#09111E]/60 uppercase tracking-tighter pl-1">Security Password</label>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full px-6 py-4 pr-16 bg-white border border-brand-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 transition-all text-sm font-bold text-[#09111E] placeholder:text-[#09111E]/20 shadow-sm"
                />
                <button
                  type="button"
            ...
            >
              {isLoggingIn ? (
                ...
                <> Access Network <ArrowRight size={18} /> </>
              )}
            </button>
          </form>
