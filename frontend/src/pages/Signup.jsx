    ...
    <div className={`${dark ? 'dark' : ''}`}>
      <div className="min-h-screen flex items-center justify-center overflow-hidden relative bg-gradient-to-b from-white to-brand-50 dark:from-[#0B0B10] dark:to-[#0B0B10] p-4">
        ...
        <div className="relative flex flex-col lg:flex-row w-full max-w-6xl min-h-[85vh] lg:h-[90vh] rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden bg-white/80 dark:bg-white/5 backdrop-blur-xl border border-white/30 dark:border-white/10">
          {/* Form Section */}
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 lg:p-10 bg-gradient-to-b from-white/90 to-brand-50/60 dark:from-white/[0.06] dark:to-white/[0.02] relative">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:space-x-4 gap-4 sm:gap-0">
                  <div className="space-y-2 w-full sm:w-1/2">
                    <label className="text-sm sm:text-md font-medium text-gray-700">Enterprise Name</label>
                    <input
                      type="text"
                      name="enterpriseName"
                  ...
                  <div className="space-y-2 w-full sm:w-1/2">
                    <label className="text-sm sm:text-md font-medium text-gray-700">Business Email</label>
                    <input
                      type="email"
                      name="email"
                      placeholder="Email"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-12 border border-gray-200 dark:border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500/40 focus:border-transparent text-sm bg-white/80 dark:bg-white/5 dark:text-white"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-brand-500 flex items-center justify-center"
                    >
