...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-brand-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-4xl w-full text-center relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-8 sm:mt-12 flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-3 text-gray-500 px-4"
          >
