    ...
    <div className="font-afacad min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-[#FC9E4F] flex justify-between items-center px-6 py-2 shadow-md">
        ...
        <div className="flex items-center p-2 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30">
          <h3 className="font-bold text-white px-2">SALES</h3>
        </div>
      </div>
        ...
        <div className="flex-1 py-8 px-4 md:px-8 flex justify-center items-start">
          <div className="bg-white rounded-3xl p-8 w-full max-w-2xl shadow-xl border border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl font-bold text-black">Add Daily Sales</h2>
                <p className="text-sm text-gray-500 font-medium">Enter your trading data for today</p>
              </div>
              <div className={`text-right text-lg font-bold ${draftPL >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-6" onSubmit={handleSubmit}>
              ...
              <div className="col-span-1">
                <label className="block text-sm font-bold text-black mb-1">Item Sold</label>
                <input
                  type="text"
                  name="itemSold"
              ...
              <div className="col-span-1">
                <label className="block text-sm font-bold text-black mb-1">Buying Price (Frw)</label>
                <input
                  type="number"
                  name="buyingPrice"
              ...
              <div className="col-span-1">
                <label className="block text-sm font-bold text-black mb-1">Selling Price (Frw)</label>
                <input
                  type="number"
                  name="sellingPrice"
        ...
        <div className="w-full lg:w-[450px] bg-white border-l border-gray-100 p-8 flex flex-col h-full shadow-inner lg:shadow-none">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-sm text-gray-500 font-medium">Your trading history for this session</p>
            </div>
            <button
              onClick={clearAll}
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
              <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Net P&L</p>
              <p className={`text-xl font-bold ${totalPL >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {totalPL.toLocaleString()} Frw
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto pr-2 space-y-4">
            {trades.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-64 text-gray-400">
                ...
                <p className="font-bold">No trades recorded yet</p>
