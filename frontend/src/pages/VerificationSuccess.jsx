            ...
            <div className="w-full flex flex-col justify-center p-10 bg-gradient-to-b from-white/90 to-brand-50/60 dark:from-white/[0.06] dark:to-white/[0.02] relative">
              ...
              <div className="w-full max-w-2xl mx-auto text-center space-y-8">
                ...
                <div className="bg-gradient-to-r from-brand-50 to-amber-50 dark:from-brand-900/20 dark:to-amber-900/20 p-6 rounded-xl border border-brand-200 dark:border-brand-800">
                  ...
                  <div className="flex items-center justify-center gap-2 text-sm text-black dark:text-black">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <button
                    ...
                    className="px-8 py-4 border-2 border-brand-300 dark:border-brand-600 text-black dark:text-black font-semibold rounded-xl hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                ...
                <div className="pt-8 border-t border-gray-200 dark:border-white/10">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="#" className="text-black dark:text-black hover:underline">
